...
def glossario(request):
    ...
    if query:
        ...
        query = request.GET.get('q') #q è variabile risultante dalla query del database
        selected_entries = glossary_entry.objects.filter(Q(Acronimo_ch__icontains=query)|Q(Acronimo_it__icontains=query)|Q(Ambito_riferimento_ch__icontains=query)|Q(Ambito_riferimento_it__icontains=query)|Q(Autore_definizione_ch__icontains=query)|Q(Autore_definizione_it__icontains=query)|Q(Autore_documento_fonte_ch__icontains=query)|Q(Autore_documento_fonte_it__icontains=query)|Q(Data_inserimento_entry__icontains=query)|Q(Definizione_ch__icontains=query)|Q(Definizione_it__icontains=query)|Q(Host_documento_fonte_ch__icontains=query)|Q(Host_documento_fonte_it__icontains=query)|Q(Id_statico_entry__icontains=query)|Q(Lemma_ch__icontains=query)|Q(Lemma_it__icontains=query)|Q(Posizione_definizione_ch__icontains=query)|Q(Posizione_definizione_it__icontains=query)|Q(Titolo_documento_fonte_ch__icontains=query)|Q(Titolo_documento_fonte_it__icontains=query)|Q(Url_definizione_ch__icontains=query)|Q(Url_definizione_it__icontains=query)|Q(Url_documento_fonte_ch__icontains=query)|Q(Url_documento_fonte_it__icontains=query))
